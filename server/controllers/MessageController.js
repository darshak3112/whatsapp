...
export const getInitialContactsWithMessages = async (req, res, next) => {
  try {
    ...
    messages.forEach((msg) => {
      const isSener = msg.senderId === userId;
      const calculatedId = isSener ? msg.recieverId : msg.senderId
      ...
      if (!users.get(calculatedId)) {
        ...
        let user = { messageId: id, type, message, messageStatus, createdAt, senderId, recieverId }
      ...
      } else if (msg.messageStatus !== "read" && !isSener) {
